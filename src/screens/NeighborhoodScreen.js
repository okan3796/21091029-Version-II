...
export default function NeighborhoodScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.mahalle1} onPress={() => navigation.navigate('Facilities')} />
      <TouchableOpacity style={styles.mahalle2} onPress={() => navigation.navigate('Facilities')} />
      <TouchableOpacity style={styles.mahalle3} onPress={() => navigation.navigate('Facilities')} />
      <TouchableOpacity style={styles.mahalle4} onPress={() => navigation.navigate('Facilities')} />
    </View>
  );
}
